# PaperPilot v5.5：QASPER 端到端 Answer F1 实验

## 结论

PaperPilot 已从“能否检索到证据”推进到“检索后能否生成正确答案”。冻结协议在 AllenAI QASPER v0.3 官方 test 的全部 1,451 个问题上运行，使用 Hybrid+Rerank Top-5 证据和 DeepSeek Chat，最终得到：
...
D:\SOFTWARE\spyder\envs\storm\python.exe `
  ...
  --cache-dir C:\Users\yzy\Desktop\codex\paperpilot-benchmarks `
  --top-k 5
```
