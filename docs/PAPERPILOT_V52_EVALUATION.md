...
```powershell
D:\SOFTWARE\spyder\envs\storm\python.exe -m knowledge_storm.paperpilot_real_eval_v52 `
  --zotero-root $env:PAPERPILOT_ZOTERO_ROOT `
  --output-dir results\paperpilot_real_eval_v52 `
