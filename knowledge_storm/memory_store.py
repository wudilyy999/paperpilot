...
from .memory_policy import MemoryCandidate, MemoryWritePolicy, _model_dump
...
class LongTermMemoryService:
    ...
    def __init__(
        ...
        legacy_db = self.root_dir / "memory_v56.sqlite3"
        self.db_path = legacy_db if legacy_db.exists() else self.root_dir / "memory.sqlite3"
