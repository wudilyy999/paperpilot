...
class PaperPilotTraceRecorder:
    def __init__(
        ...
        self.trace_path = str(Path(article_dir) / "paperpilot_trace.jsonl")
    ...
    def _export_observation_event(self, record):
        ...
        try:
            ...
            # already counted by PaperPilotObservability; bridge shape errors are
...
class PaperPilotStageCallback:
    def __init__(self, trace_recorder: PaperPilotTraceRecorder, topic: str):
...
class TracedRetrievalModel:
    def __init__(self, rm, trace_recorder: PaperPilotTraceRecorder, retriever_name: str):
        self.rm = rm
        self.trace_recorder = trace_recorder
