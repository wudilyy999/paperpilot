...
class PaperPilotKnowledgeBase:
    ...
    def answer_question(
        self,
        question: str,
        memory_store: Optional[PaperPilotMemoryStore] = None,
        top_k: int = 3,
        ...
        from .paperpilot_references import append_answer_references
    ...
    def search(self, query: str, top_k: int = 3, **retrieval_options):
        ...
        raise RuntimeError(
            "PaperPilotKnowledgeBase requires a run_dir or RetrievalPipeline"
        )
