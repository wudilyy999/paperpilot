...
class RetrievalTool(PaperPilotTool):
    input_schema = {
        "type": "object",
        "properties": {
            "query": {
...
class KnowledgeBaseQATool(PaperPilotTool):
    name = "kb_qa"
    description = (
        "Answer a question from an existing PaperPilot run directory using generated "
    ...
    input_schema = {
        ...
        "properties": {
            "run_dir": {
                "type": "string",
                "description": "PaperPilot topic output directory containing article and retrieval artifacts.",
            },
            "question": {
                "type": "string",
...
class ResearchQATool(PaperPilotTool):
    name = "research_qa"
    description = (
        "Ask the PaperPilot Research QA Agent. It can reuse an existing task_id or "
    ...
    input_schema = {
        ...
        "properties": {
            ...
            "task_id": {"type": "string", "description": "Existing PaperPilot task id."},
    ...
    def __init__(self, service_root="./results/paperpilot_tool_service"):
        self.service = PaperPilotTaskService(root_dir=service_root)
...
def list_paperpilot_tools(pdf_dir=None):
