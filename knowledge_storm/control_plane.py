...
class ProductionRuntime:
    ...
    def __init__(
        ...
        legacy_control = self.root_dir / "production_v45.sqlite"
    ...
    def _graph_root(self):
        ...
        legacy = self.root_dir / "langgraph_v44"
    ...
    def invoke(self, tenant_id: str = "local", **payload):
        ...
        def run_graph():
            ...
            with self.control.trace_span(
                ...
                memory_root = Path(self.task_service.root_dir) / "memory_service"
                legacy_memory_root = Path(self.task_service.root_dir) / "memory_service_v56"
                memory_service = LongTermMemoryService(
                    legacy_memory_root if legacy_memory_root.exists() else memory_root,
            ...
            return dict(
                ...
                graph_runtime=graph_result.get("runtime", "conversation-runtime"),
                trace_id=trace_id,
            )
...
class _TraceSpan(AbstractContextManager):
    def __init__(
