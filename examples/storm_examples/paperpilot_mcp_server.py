"""
Minimal MCP-style stdio server for PaperPilot retrieval tools.

Example:
    python examples/storm_examples/paperpilot_mcp_server.py --pdf-dir ./papers
"""
...
from knowledge_storm.paperpilot_tools import list_paperpilot_tools
from knowledge_storm.paperpilot_runtime import ToolRegistry
...
def build_tool_registry(pdf_dir=None):
    ...
    for tool in list_paperpilot_tools(pdf_dir=pdf_dir):
...
def main():
    parser = argparse.ArgumentParser(
        description="Expose PaperPilot retrieval tools over a minimal MCP-style stdio server."
    )
    parser.add_argument(
        "--pdf-dir",
        default=None,
