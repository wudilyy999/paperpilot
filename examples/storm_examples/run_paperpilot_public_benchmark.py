"""Run PaperPilot public retrieval benchmarks from official local data."""
...
def build_parser():
    parser = argparse.ArgumentParser(description="PaperPilot public benchmark")
    parser.add_argument("--benchmark", choices=("scifact", "qasper"), required=True)
    parser.add_argument("--dataset-dir")
    parser.add_argument(
        "--cache-dir", default=str(Path.home() / ".cache" / "paperpilot")
    )
