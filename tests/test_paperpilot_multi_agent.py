...
class PaperPilotMultiAgentTest(unittest.TestCase):
    ...
    def test_planner_generates_query_plan_with_intents(self):
        from knowledge_storm.paperpilot_agents import PlannerAgent
    ...
    def test_critic_filters_offtopic_pim_results_with_reasons(self):
        from knowledge_storm.paperpilot_agents import CriticAgent
    ...
    def test_orchestrator_runs_multi_agent_research_and_writes_agent_trace(self):
        from knowledge_storm.paperpilot_agents import PaperPilotResearchOrchestrator
        from knowledge_storm.paperpilot_runtime import PaperPilotRuntimeSession

        output_dir = self.make_output_dir()
        trace_path = output_dir / "paperpilot_trace.jsonl"
        ...
        orchestrator = PaperPilotResearchOrchestrator(session=session, output_dir=output_dir)
    ...
    def test_multi_agent_eval_scores_agent_trace_and_critic_rejections(self):
        from knowledge_storm.paperpilot_agents import evaluate_multi_agent_report
