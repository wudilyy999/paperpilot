...
class PaperPilotMCPServerTest(unittest.TestCase):
    def test_tools_list_returns_registered_tool_schemas(self):
        from examples.storm_examples.paperpilot_mcp_server import (
    ...
    def test_build_tool_registry_includes_arxiv_by_default(self):
        from examples.storm_examples.paperpilot_mcp_server import build_tool_registry
