...
class PaperPilotMilestoneTest(unittest.TestCase):
    def test_parser_defaults_to_affected_p1_benchmarks(self):
        from examples.storm_examples.run_paperpilot_milestone import build_parser, resolve_benchmarks
    ...
    def test_benchmark_protocol_uses_development_splits_and_baseline_top_k(self):
        from examples.storm_examples.run_paperpilot_milestone import _protocol_for
    ...
    def test_incompatible_protocol_is_explicit_and_has_no_delta(self):
        from examples.storm_examples.run_paperpilot_milestone import _comparison_metadata
    ...
    def test_p2_comparison_uses_matching_p1_predictions(self):
        from examples.storm_examples.run_paperpilot_milestone import _p2_comparison
    ...
    def test_evidence_governance_benchmark_writes_fixed_case_dossiers(self):
        from examples.storm_examples.run_paperpilot_milestone import _run_evidence_governance
    ...
    def test_p2_qasper_smoke_runs_governed_pipeline_against_p1(self):
        from examples.storm_examples import run_paperpilot_milestone as module
    ...
    def test_blocked_run_returns_distinct_nonzero_exit_code(self):
        from examples.storm_examples.run_paperpilot_milestone import exit_code
    ...
    def test_qasper_retrieval_excludes_cases_without_gold_evidence(self):
        from examples.storm_examples.run_paperpilot_milestone import _retrieval_cases_only
    ...
    def test_pim_top_k_hit_with_wrong_top1_is_not_resolved(self):
        from examples.storm_examples.run_paperpilot_milestone import _pim_dossiers
    ...
    def test_change_does_not_claim_filtering_when_plan_has_no_filters(self):
        from examples.storm_examples.run_paperpilot_milestone import _actual_change
