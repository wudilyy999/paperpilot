...
class PaperPilotEvalTest(unittest.TestCase):
    ...
    def test_evaluate_run_scores_completion_retrieval_article_and_trace(self):
        from knowledge_storm.paperpilot_eval import EvalCase, evaluate_run
    ...
    def test_write_scorecards_outputs_json_and_markdown(self):
        from knowledge_storm.paperpilot_eval import write_scorecards
        ...
        self.assertIn("PaperPilot Eval Scorecard", md_path.read_text(encoding="utf-8"))
