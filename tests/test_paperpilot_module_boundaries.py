...
REMOVED_LEGACY_MODULES = (
    "paperpilot_context_v42.py",
    "paperpilot_context_v56.py",
    "paperpilot_document_v41.py",
    "paperpilot_eval_v4.py",
    "paperpilot_eval_v54.py",
    "paperpilot_langgraph_v44.py",
    "paperpilot_memory_v43.py",
    "paperpilot_memory_v56.py",
    "paperpilot_production_v45.py",
    "paperpilot_rag.py",
    "paperpilot_retrieval_runtime.py",
    "paperpilot_retrieval_v41.py",
)


class PaperPilotModuleBoundaryTest(unittest.TestCase):
    def test_production_modules_do_not_import_versioned_modules(self):
        ...
        for path in PACKAGE.glob("*.py"):
            ...
            for node in ast.walk(tree):
                ...
                for name in names:
                    if "paperpilot_" in name and any(
    ...
    def test_stable_runtime_modules_are_importable(self):
        ...
        self.assertTrue(conversation_runtime.PaperPilotConversationRuntime)
