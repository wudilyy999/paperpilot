...
class PaperPilotReferencesTest(unittest.TestCase):
    ...
    def test_loads_canonical_title_authors_and_arxiv_links(self):
        from knowledge_storm.paperpilot_references import load_reference_registry
    ...
    def test_materializes_one_idempotent_reference_section_in_article(self):
        from knowledge_storm.paperpilot_references import materialize_article_references
    ...
    def test_answer_reference_renderer_uses_structured_citations(self):
        from knowledge_storm.paperpilot_references import append_answer_references
    ...
    def test_existing_model_reference_section_does_not_hide_canonical_links(self):
        from knowledge_storm.paperpilot_references import (
