...
class PaperPilotRetrieversTest(unittest.TestCase):
    ...
    def test_arxiv_rm_skips_memory_pim_queries_when_using_paperpilot(self):
        rm = ArxivRM(k=1)
        calls = []
        rm.request = lambda query: calls.append(query) or ARXIV_SAMPLE
    ...
    def test_arxiv_search_tool_exposes_schema_and_runs(self):
        from knowledge_storm.paperpilot_tools import ArxivSearchTool
    ...
    def test_local_pdf_search_tool_exposes_schema_and_runs(self):
        from knowledge_storm.paperpilot_tools import LocalPDFSearchTool
