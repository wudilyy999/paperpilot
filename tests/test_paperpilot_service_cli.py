...
class PaperPilotServiceCliTest(unittest.TestCase):
    def test_single_task_cli_parser_supports_real_pipeline_options(self):
        from examples.storm_examples.run_paperpilot_service_task import build_parser
        ...
        self.assertEqual(args.run_mode, "paperpilot")
